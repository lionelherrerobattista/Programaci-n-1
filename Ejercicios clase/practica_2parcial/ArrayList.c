...
int al_add(ArrayList* this, void* pElement)
{
    ...
    if(this!=NULL && pElement!=NULL)
    {
        ...
        if(longitud == this->reservedSize)//si esta agotada la capacidad de la memoria, hago el realloc para que no se pise
        {
...
ArrayList* al_clone(ArrayList* this)
{
    ...
    if(this!=NULL)
    {
        ...
        aux->size=longitud; //copia el cantidad de elementos
...
int resizeUp(ArrayList* this) //agranda el tamaño del array
{
    ...
    {
        longitud= this->len(this); //mido el tamaño de la lista
        if(longitud == this->reservedSize) //si llega al tope
        {
...
int resizeDown(ArrayList* this)//achicar el tamaño del array // lo contrario del resizeUp
{
    ...
    {
        longitud= this->len(this); //mido el tamaño de la lista
        if( this->reservedSize-longitud >AL_INCREMENT) //
        {
            aux = (void**) realloc(this->pElements, sizeof(void*)* (this->reservedSize - AL_INCREMENT)); //agrando espacio
            if(aux!=NULL)
            {
...
/*void ingresoDni (ArrayList* this)
{
    int numero;
