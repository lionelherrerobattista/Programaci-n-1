...
ePersona** crearLista(int sizeArray)
{
    ...
    ePersona** listaPersonas; //Puntero donde se guarda el array de punteros

    //Creo el array de punteros persona de forma dinámica:
...
/*Si uso esta funcion los punteros pierden la referencia al hacer realloc !!!!
usar variables globales o estructuras para lista
